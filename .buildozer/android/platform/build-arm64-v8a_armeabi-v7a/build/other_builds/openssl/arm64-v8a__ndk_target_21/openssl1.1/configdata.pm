...
our %config = (
  ...
  CPPFLAGS => [ "-DANDROID -I/home/hadeel/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include -I/home/hadeel/Desktop/fundrApp/.buildozer/android/platform/build-arm64-v8a_armeabi-v7a/build/python-installs/myapp/arm64-v8a/include/python3.1" ],
  CPPINCLUDES => [  ],
  ...
  LDFLAGS => [ "  -L/home/hadeel/Desktop/fundrApp/.buildozer/android/platform/build-arm64-v8a_armeabi-v7a/build/libs_collections/myapp/arm64-v8a" ],
  LDLIBS => [ "-lm" ],
  PERL => "/usr/bin/perl",
  RANLIB => ":",
  RC => "windres",
